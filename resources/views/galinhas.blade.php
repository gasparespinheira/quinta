            ...
            <section class="py-5">
                <div class="container px-5 my-5">
                    <div class="text-center mb-5">
                        <h1 class="fw-bolder">Galinhas</h1>
                    </div>

                    <div class="col-mod-10">
                <div id="listaGalinhas" class="row" style="...">
                    @foreach($galinhas as $galinha)
                     <div class="card text-center row-cols-1" style="width: 18rem; margin: 10px;">
                        <div class="card-body">
                            <h5 class="card-title">{{$galinha->nome}}</h5>
                            <p class="card-text">Preço: {{$galinha->preco}} €</p>
                            <p class="card-text">Género: {{$galinha->genero}} </p>
                            <p class="card-text">Idade: {{$galinha->idade}} anos </p>
                        </div>
                    </div>
                    @endforeach
                    </div>
